...
function Home() {
  return (
    <div>
        ...
        <Banner imageUrl={`https://assets.tatacliq.com/medias/sys_master/images/63588842831902.png`} />
        ...
        <Banner imageUrl={`https://assets.tatacliq.com/medias/sys_master/images/63588844339230.png`} />
        <Banner imageUrl={`https://assets.tatacliq.com/medias/sys_master/images/49733188190238.jpg`}/>
