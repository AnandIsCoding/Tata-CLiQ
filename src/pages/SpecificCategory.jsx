  ...
  return (
    ...
    <div className="flex flex-col lg:flex-row px-2 md:px-10 py-8 gap-8 min-h-screen bg-gray-50 w-screen overflow:hidden">
      ...
      <div className="flex-1">
        <h1 className="text-3xl font-bold capitalize text-center">{category}</h1>
        <p className="font-normal mb-6 capitalize text-center text-gray-600">{products.length} Products</p>
