    ...
    <footer className="bg-gray-100 text-gray-700 py-10 text-sm">
        ...
        <div className="grid grid-cols-4 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#">Furniture Return Policy</a>
              </li>
              <li>
      ...
      <a href="#" className="underline mx-1">accessories</a>  */}
        ...
        <div>
          ...
          <p>
            The upside of online shopping at Tata CLiQ FASHION online store, is
            that you'll save on time and most importantly money with Tata Cliq
            FASHION offers. It's as simple as comparing products and prices
            online before making the right buy. What's more, you also have the
            option to pay for your favourite brands and products using our easy
            EMI options. Of course, you can buy and try – in the convenience of
        ...
        <div>
          ...
          <p>
            ...
            ensure you're buying something perfect. With constant updates and a
            host of new features being introduced constantly, enjoy a shopping
        ...
        <div>
          ...
          <p>
            ...
            we have most of your trendy shopping needs taken care of. Make Tata
            CLiQ FASHION your online shopping destination and get the best deals
            on your favourite brands, with 100% genuine products. Be it
            jewellery or makeup, you can count on Tata CLiQ FASHION for
            receiving only the most authentic products.
          </p>
        </div>
      </div>
    </footer>
