...
function ProductCard({product}) {
  ...
  return (
    <div
                 ...
                 className="bg-white cursor-pointer p-4 relative group rounded-md hover:shadow-lg transition-all"
               >
                 ...
                 <div className="mt-3 flex items-center gap-2">
                   ...
                   <span className="text-gray-400 line-through text-sm">₹{(product.price * 10)}</span>
